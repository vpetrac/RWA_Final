...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="p-5">
            ...
            <ContentTemplate>
                <div class="form-row">
                    <div class="form-group col-md-3">
                        ...
                        <asp:DropDownList AutoPostBack="True" ID="filter_country" class="form-control" runat="server" OnSelectedIndexChanged="filter_country_SelectedIndexChanged">
                            <asp:ListItem>Sve države</asp:ListItem>
                        </asp:DropDownList>
                    </div>
                    <div class="form-group col-md-3">
                        <label for="inputState">City</label>
                        <asp:DropDownList AutoPostBack="True" ID="filter_city" class="form-control" runat="server" OnSelectedIndexChanged="filter_city_SelectedIndexChanged">
                            <asp:ListItem>Svi gradovi</asp:ListItem>
                        </asp:DropDownList>
                    </div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1"
            ...
            ConnectionString="<%$ ConnectionStrings:AdventureWorksOBPConnectionString2 %>"
